...
export default function MinhaContaPage() {
  return (
    <>
      <Header />
      <main className="flex-1 bg-[--color-mp-paper]">
        <Container>
          <div className="py-12">
          ...
          <div className="grid md:grid-cols-[260px_1fr] gap-6 pb-20">
            ...
            <div className="space-y-6">
              {/* Active reservation */}
              <div className="rounded-2xl bg-white border border-[--color-mp-line] p-6">
                <div className="flex items-center justify-between mb-4">
                  <Badge variant="success" dot>Reserva ativa</Badge>
                  <span className="font-mono text-xs text-[--color-mp-text-soft]">
                    MP-2026-A8F3K
                  </span>
                </div>
                <div className="grid md:grid-cols-[1fr_auto] gap-4 items-end">
                  <div>
                    ...
                    <div className="mt-1 text-[--color-mp-text-soft]">
                      14 mai · 06:00 → 21 mai · 22:00 · 7 dias
                    </div>
                    <div className="mt-1 text-sm text-[--color-mp-text-soft]">
                      Honda Civic · ABC1D23
                    </div>
                  </div>
              ...
              <div className="rounded-2xl bg-white border border-[--color-mp-line] p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link href="#" className="text-sm font-medium text-[--color-mp-red]">
                    Ver tudo →
                  </Link>
                </div>
                  ...
                  {[
                    ...
                    <div key={h.date} className="py-3.5 flex items-center justify-between">
                      <div>
                        ...
                        <div className="text-xs text-[--color-mp-text-soft] mt-0.5">{h.date}</div>
                      </div>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="rounded-2xl bg-[--color-mp-ink] text-white p-6">
                  <Tag className="h-6 w-6 text-[--color-mp-red] mb-3" />
                  ...
                  <button className="mt-3 text-sm font-medium text-[--color-mp-red] flex items-center gap-1">
                    Recarregar <ArrowRight className="h-3.5 w-3.5" />
                  </button>
                </div>
                <div className="rounded-2xl bg-white border border-[--color-mp-line] p-6">
                  <div className="font-mono text-[10px] uppercase tracking-[0.18em] text-[--color-mp-text-soft] mb-1">
                    Multicliente · status
                  </div>
