...
export function TagBanner() {
  return (
    <section className="py-20 md:py-24">
      <Container>
        <div className="relative rounded-[28px] bg-[var(--color-mp-ink)] text-white overflow-hidden p-8 md:p-14 lg:p-16">
          {/* glow */}
          <div
          ...
          <div className="grid md:grid-cols-[1.3fr_1fr] gap-10 md:gap-12 items-center relative">
            <div>
              ...
              <h2 className="text-3xl md:text-5xl font-semibold tracking-tight leading-[1.05]">
                Passe sem parar
                <br />
                em <span className="text-[var(--color-mp-red)]">40+ unidades</span>
            ...
            <div className="relative h-[280px] md:h-[360px] flex items-center justify-center">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="h-44 w-72 md:h-56 md:w-96 bg-white rounded-2xl shadow-2xl rotate-[-6deg] relative overflow-hidden">
                  <div className="absolute inset-0 bg-gradient-to-br from-white via-white to-[var(--color-mp-cream)]" />
                  <div className="absolute top-4 left-4 right-4 flex items-start justify-between">
                    <div>
                      <div className="font-mono text-[9px] tracking-[0.2em] text-[var(--color-mp-text-muted)]">
                        TAG · MULTIPARK
                      </div>
                      <div className="text-[var(--color-mp-ink)] font-bold text-2xl md:text-3xl mt-1 tracking-tight">
                        Multi<span className="text-[var(--color-mp-red)]">ParK</span>
                      </div>
                    </div>
                  ...
                  <div className="absolute bottom-4 left-4 right-4 flex items-end justify-between">
                    <div className="font-mono text-[10px] text-[var(--color-mp-text-soft)]">
                      ID 0042 8821 · ATIVA
                    </div>
                    <div className="h-1 w-12 bg-[var(--color-mp-red)] rounded-full" />
                  </div>
                </div>
              </div>
            </div>
